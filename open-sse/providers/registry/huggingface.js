export default {
  ...
  // `inputs` and the prompt under `parameters.prompt`.
  ...
  // No `params`: the router's ASR payload carries only `inputs` and
  // `parameters.return_timestamps`, so a UI-declared "language" would be dropped.
  sttConfig: {
