...
// Codex CLI's auto-review sends the bare model id "codex-auto-review". Without the prefix
// rule it falls through to the "openai" default and fails with
// "No active credentials for provider: openai".
describe("codex auto-review routing", () => {
